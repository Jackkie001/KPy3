...
RfuBot=[lineMID]
Family=["u800b5f33bdfebcc0f2f878ff5c712180",lineMID]
admin=['u800b5f33bdfebcc0f2f878ff5c712180',lineMID]
...
#==============================================================================#
                    ...
                    start = time.time()
                    line.sendMessage(to, "👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑")
                    ...
                    try:
                        arr = []
                        owner = "u800b5f33bdfebcc0f2f878ff5c712180"
...
#==============================================================================#
                    ...
                    line.sendMessage(to, "😀😀เปิดออโต้บ๊อคแล้ว😀😀")
                elif text.lower() == 'ปิดแอด':
                    settings["autoAdd"] = False
                    line.sendMessage(to, "😀😀ปิดออโต้บ๊อคแล้ว😀😀")
                    ...
                    line.sendMessage(to, "😊😊เปิดอ่านเรียบร้อยครับ😊😊")
                    ...
                    line.sendMessage(to, "😊😊ปิดอ่านเรียบร้อยครับ😊😊")
                elif text.lower() == 'เปิดติก':
                    settings["checkSticker"] = True
                    line.sendMessage(to, "😊😊เปิดเช็คโค๊ชสติกเกอร์เรียบร้อยครับ😊😊")
                elif text.lower() == 'ปิดติก':
                    settings["checkSticker"] = False
                    line.sendMessage(to, "😊😊ปิดเช็คโค๊ชสติกเกอร์เรียบร้อยครับ😊😊")
...
#==============================================================================#
                    ...
                    sendMessageWithMention(to, lineMID)
                    line.sendContact(to, "u800b5f33bdfebcc0f2f878ff5c712180")
...
#=============COMMAND KICKER===========================#
                	...
                	if msg.toType == 2:
                        ...
                        if msg._from in Family:
                            try:
                                ...
                                line.sendMessage(msg.to,"😄😄กูล้างแชทให้มึงรีบร้อยแล้ว😄😄")
                            except:
                                pass
                                print ("😄😄กูล้างแชทให้มึงรีบร้อยแล้ว😄😄")
                    ...
                    if msg._from in Family:
                        ...
                        line.sendMessage(msg.to,"😄😄อัพเดชชื่อเรียบร้อย😄😄 " + string)
                        print ("Update Name")
                    ...
                    if msg._from in Family:
                        ...
                        line.updateProfile(profile_A)
                        line.sendMessage(msg.to,"😄😄อัพเดชสเตตัสเรียบร้อย😄😄 " + string)
                ...
                elif text.lower() == "เด็กๆ":
                    if msg._from in Family:
                        profile = ki.getProfile()
                        text = profile.displayName + "\n 😉😉พร้อมจะบินแล้วครับเจ้านาย😉😉"
                    ...
                    ki.sendMessage(msg.to,"👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑")
                    kk.sendMessage(msg.to,"👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑")
                    kc.sendMessage(msg.to,"👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑")
                    ke.sendMessage(msg.to,"👑ŤỂÄΜ ж βǾŦ👑฿Ǿ¥👑")    
