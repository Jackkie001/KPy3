...
def helpmessage():
    if settings['setKey'] == True:
        ...
        key = ''
    helpMessage =   "âââ[ Help Message ]" + "\n" + \
                    "â  " + key + "Help" + "\n" + \
                    "â  " + key + "Translate" + "\n" + \
                    "â  " + key + "TTS" + "\n" + \
                    "â ââ[ Status Command ]" + "\n" + \
                    "â  " + key + "Restart" + "\n" + \
                    "â  " + key + "Runtime" + "\n" + \
                    "â  " + key + "Speed" + "\n" + \
                    "â  " + key + "Status" + "\n" + \
                    ...
                    "â  " + key + "AutoJoinTicketãOn/Offã" + "\n" + \
                    "â  " + key + "AutoLeaveãOn/Offã" + "\n" + \
                    "â  " + key + "AutoReadãOn/Offã" + "\n" + \
                    "â  " + key + "AutoResponãOn/Offã" + "\n" + \
                    "â  " + key + "CheckContactãOn/Offã" + "\n" + \
                    "â  " + key + "CheckPostãOn/Offã" + "\n" + \
                    "â  " + key + "CheckStickerãOn/Offã" + "\n" + \
                    "â  " + key + "UnsendChatãOn/Offã" + "\n" + \
                    "â ââ[ Self Command ]" + "\n" + \
                    "â  " + key + "ChangeName:ãQueryã" + "\n" + \
                    "â  " + key + "ChangeBio:ãQueryã" + "\n" + \
                    "â  " + key + "Me" + "\n" + \
                    "â  " + key + "MyMid" + "\n" + \
                    "â  " + key + "MyName" + "\n" + \
                    "â  " + key + "MyBio" + "\n" + \
                    ...
                    "â  " + key + "MyCover" + "\n" + \
                    "â  " + key + "StealContactãMentionã" + "\n" + \
                    "â  " + key + "StealMidãMentionã" + "\n" + \
                    "â  " + key + "StealNameãMentionã" + "\n" + \
                    "â  " + key + "StealBioãMentionã" + "\n" + \
                    "â  " + key + "StealPictureãMentionã" + "\n" + \
                    "â  " + key + "StealVideoProfileãMentionã" + "\n" + \
                    "â  " + key + "StealCoverãMentionã" + "\n" + \
                    "â  " + key + "CloneProfileãMentionã" + "\n" + \
                    "â  " + key + "RestoreProfile" + "\n" + \
                    "â  " + key + "BackupProfile" + "\n" + \
                    "â  " + key + "ChangePictureProfile" + "\n" + \
                    "â ââ[ Group Command ]" + "\n" + \
                    "â  " + key + "GroupCreator" + "\n" + \
                    "â  " + key + "GroupId" + "\n" + \
                    "â  " + key + "GroupName" + "\n" + \
                    "â  " + key + "GroupPicture" + "\n" + \
                    "â  " + key + "GroupTicket" + "\n" + \
                    "â  " + key + "GroupTicketãOn/Offã" + "\n" + \
                    "â  " + key + "GroupList" + "\n" + \
                    "â  " + key + "GroupMemberList" + "\n" + \
                    "â  " + key + "GroupInfo" + "\n" + \
                    "â  " + key + "ChangeGroupPicture" + "\n" + \
                    "â ââ[ Special Command ]" + "\n" + \
                    "â  " + key + "MimicãOn/Offã" + "\n" + \
                    "â  " + key + "MimicList" + "\n" + \
                    "â  " + key + "MimicAddãMentionã" + "\n" + \
                    "â  " + key + "MimicDelãMentionã" + "\n" + \
                    "â  " + key + "Mention" + "\n" + \
                    "â  " + key + "LurkingãOn/Off/Resetã" + "\n" + \
                    "â  " + key + "Lurking" + "\n" + \
                    "â ââ[ Media Command ]" + "\n" + \
                    "â  " + key + "CheckDateãDateã" + "\n" + \
                    "â  " + key + "CheckWebsiteãurlã" + "\n" + \
                    "â  " + key + "CheckPraytimeãLocationã" + "\n" + \
                    "â  " + key + "CheckWeatherãLocationã" + "\n" + \
                    "â  " + key + "CheckLocationãLocationã" + "\n" + \
                    "â  " + key + "InstaInfo ãUserNameã" + "\n" + \
                    "â  " + key + "InstaPost ãUserNameã|ãNumberã" + "\n" + \
                    "â  " + key + "InstaStory ãUserNameã|ãNumberã" + "\n" + \
                    "â  " + key + "SearchYoutubeãSearchã" + "\n" + \
                    "â  " + key + "SearchMusic ãSearchã" + "\n" + \
                    "â  " + key + "SearchLyric ãSearchã" + "\n" + \
                    "â  " + key + "SearchImage ãSearchã" + "\n" + \
                    "âââBY⍣⌲【✥ͲᎪᎬᎷßΘͲ ĦᏌᎪ~ᎡᎾᎾΝ~ᎡᎪΝᏀ✥】"
    return helpMessage
        ...
        if op.type == 11:
            ...
            if settings["qrprotect"] == True:
                if op.param2 in admin:
                    ...
                    gs = line.getGroup(op.param1)
                    gs.preventJoinByTicket = True
                    line.updateGroup(gs)
                    invsend = 0
                    line.sendMessage(op.param1,line.getContact(op.param2).displayName + "อย่าเปิดลิ้ง！")
        ...
        if op.type == 13:
            ...
            if settings["inviteprotect"] == True:
                if op.param2 in admin:
                    ...
                    time.sleep(0.15)
                    line.kickoutFromGroup(op.param1,[op.param3])
                    time.sleep(0.15)
                    line.kickoutFromGroup(op.param1,[op.param2])
...
#==============================================================================#
                ...
                elif text.lower() == 'เปิดเชคโพสต์':
                     settings["checkPost"] = True
                     line.sendMessage(to, "【✥⍣ทำการเปิดเชคโพสต์แล้ว⍣✥】✔")
                elif text.lower() == 'ปิดเชคโพสต์':
                     settings["checkPost"] = False
                     line.sendMessage(to, "【✥⍣ทำการปิดเชคโพสต์แล้ว⍣✥】❌")
                ...
                elif text.lower() == 'เปิดลบแชท':
                    settings["unsendMessage"] = True
                    line.sendMessage(to, "【✥⍣ป้องกันคนลบข้อความแชทเปิดแล้ว⍣✥】✔")
                elif text.lower() == 'ปิดลบแชท':
                    settings["unsendMessage"] = False
                    line.sendMessage(to, "【✥⍣การป้องกันคนลบข้อแชทปิดแล้ว⍣✥】❌")
...
#==============================================================================#
                    ...
                    if msg.toType == 2:
                        ...
                        if group.preventedJoinByTicket == True:
                            ...
                            line.updateGroup(group)
                            line.sendMessage(to, "【✥⍣คุณได้ปิดลิ้งห้องแล้ว⍣✥】❌")
...
#==============================================================================#   
                    ...
                    line.sendMessage(msg.to,"【✥⍣ปิดแทคเรียบร้อย⍣✥】❌")
                     ...
                     line.sendMessage(to, "KeyCommand Saat ini adalah [ {} ]".format(str(settings["keyCommand"])))
                elif text.lower() == "setkey on":
                     settings["setKey"] = True
                     line.sendMessage(to, "Berhasil mengaktifkan setkey")
                 elif text.lower() == "setkey off":
                      settings["setKey"] = False
                      line.sendMessage(to, "Berhasil menonaktifkan setkey")
...
#=============COMMAND KICKER===========================#
                	...
                	if msg.toType == 2:
                        ...
                        if msg._from in Family:
                            try:
                                ...
                                line.sendMessage(msg.to,"【✥⍣ทำการล้างข้อความแชทเรียบร้อยแล้ว⍣✥】✔")
                            except:
                                pass
                                print ("【✥⍣ทำการล้างข้อความแชททั้งหมดเรียบร้อยแล้ว⍣✥】✔")
                    ...
                    if msg._from in Family:
                        ...
                        line.sendMessage(msg.to,"【✥⍣อัพเดทชื่อคิกเกอร์ทั้งหมดเรียบร้อย⍣✥】✔ : " + string)
                    ...
                    if msg._from in Family:
                        ...
                        kc.updateProfile(profile_C)
                        ke.updateProfile(profile_D)                        
                        line.sendMessage(msg.to,"【✥⍣อัพเดทสเตตัสคิกทุกตัวเรียบร้อย⍣✥】✔ : " + string)
                 ...
                 if settings["checkPost"] == True:
                            try:
                                ...
                                if msg.contentMetadata["serviceType"] == "GB":
                                    contact = lient.getContact(sender)
                                ...
                                line.sendMessage(to, "Post tidak valid")
            except Exception as error:
                logError(error)
