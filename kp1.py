...
print ("╔┅┄┄┄┄┄┄┄⊰⍣✿✯【✥ͲᎪᎬᎷßΘͲ ĦᏌᎪ~ᎡᎾᎾΝ~ᎡᎪΝᏀ✥】✯✿⍣⊱┄┄┄┄┄┄┄┅╗\n███████▓█████▓▓╬╬╬╬╬╬╬╬▓███▓╬╬╬╬╬╬╬▓╬╬▓█ \n████▓▓▓▓╬╬▓█████╬╬╬╬╬╬███▓╬╬╬╬╬╬╬╬╬╬╬╬╬█ \n███▓▓▓▓╬╬╬╬╬╬▓██╬╬╬╬╬╬▓▓╬╬╬╬╬╬╬╬╬╬╬╬╬╬▓█ \n████▓▓▓╬╬╬╬╬╬╬▓█▓╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬▓█ \n███▓█▓███████▓▓███▓╬╬╬╬╬╬▓███████▓╬╬╬╬▓█ \n████████████████▓█▓╬╬╬╬╬▓▓▓▓▓▓▓▓╬╬╬╬╬╬╬█ \n███▓▓▓▓▓▓▓╬╬▓▓▓▓▓█▓╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬▓█ \n████▓▓▓╬╬╬╬▓▓▓▓▓▓█▓╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬▓█ \n███▓█▓▓▓▓▓▓▓▓▓▓▓▓▓▓╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬▓█ \n█████▓▓▓▓▓▓▓▓█▓▓▓█▓╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬▓█ \n█████▓▓▓▓▓▓▓██▓▓▓█▓╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬██ \n█████▓▓▓▓▓████▓▓▓█▓╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬██ \n████▓█▓▓▓▓██▓▓▓▓██╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬██ \n████▓▓███▓▓▓▓▓▓▓██▓╬╬╬╬╬╬╬╬╬╬╬╬█▓╬▓╬╬▓██ \n█████▓███▓▓▓▓▓▓▓▓████▓▓╬╬╬╬╬╬╬█▓╬╬╬╬╬▓██ \n█████▓▓█▓███▓▓▓████╬▓█▓▓╬╬╬▓▓█▓╬╬╬╬╬╬███ \n██████▓██▓███████▓╬╬╬▓▓╬▓▓██▓╬╬╬╬╬╬╬▓███ \n███████▓██▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓╬╬╬╬╬╬╬╬╬╬╬████ \n███████▓▓██▓▓▓▓▓╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬▓████ \n████████▓▓▓█████▓▓╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬╬▓█████ \n█████████▓▓▓█▓▓▓▓▓███▓╬╬╬╬╬╬╬╬╬╬╬▓██████ \n██████████▓▓▓█▓▓▓╬▓██╬╬╬╬╬╬╬╬╬╬╬▓███████ \n███████████▓▓█▓▓▓▓███▓╬╬╬╬╬╬╬╬╬▓████████ \n██████████████▓▓▓███▓▓╬╬╬╬╬╬╬╬██████████ \n███████████████▓▓▓██▓▓╬╬╬╬╬╬▓███████████\n╚┅┄┄┄┄┄┄┄┄┄【✥LOGIN SELFBOT COMPLETE✥】┄┄┄┄┄┄┄┄┄┄┅╝")
print ("Login Succes")
...
mulai = time.time() 
dangerMessage = ["cleanse","group cleansed.","mulai",".winebot",".kickall","mayhem","kick on","makasih :d","!kickall","nuke","บิน",".???","งงไปดิ","บินไปดิ","เซลกากจัง",".บิน"]
...
def myhelp():
    myHelp = "╔⍣⊰【✥Ŧ€₳ℳধ௫฿❂Ŧ🔝ҨัՁਙุЮℓℓ丂ს✥】⊱⍣╗"+ "\n" + \
                  ...
                  "╠⍣⌲「เปิดออก/ปิดออก」"+ "\n" + \
                  "╠⍣⌲「เปิดอ่าน/ปิดอ่าน」"+ "\n" + \
                  "╠⍣⌲「เปิดแทครูป/ปิดแทครูป」"+ "\n" + \
                  "╠⍣⌲「เปิดแทค1/ปิดแทค1」"+ "\n" + \
                  "╠⍣⌲「เปิดแทค2/ปิดแทค2」"+ "\n" + \
                  "╠⍣⌲「เปิดแทค3/ปิดแทค3」"+ "\n" + \
                  "╠⍣⌲「เปิดแทครูป/ปิดแทครูป」"+ "\n" + \
                  "╠⍣⌲「เปิดแทคคิก/ปิดแทคคิก」"+ "\n" + \
...
#==============================================================================#
                    ...
                    try:
                        ret_ = "        【✥Ŧ€₳ℳধ௫฿❂Ŧ🔝ҨัՁਙุЮℓℓ丂ს✥】\n╔┅⍣⊰✿【✥⍣การตั้งค่าระบบ ทั้งหมด⍣✥】✿⊱⍣┅╗"
                        if settings["autoAdd"] == True: ret_ += "\n╠⍣⌲ รับแอดอัตโนมัติ ⍣➢ เปิด ✔"
                        else: ret_ += "\n╠⍣⌲ รับแอดอัตโนมัติ ⍣➢ ปิด ❌"
                        if settings["autoBlock"] == True: ret_ += "\n╠⍣⌲ ออโต้บล๊อคอัตโนมัติ ⍣➢ เปิด ✔"
                        else: ret_ += "\n╠⍣⌲ ออโต้บล๊อคอัตโนมัติ ⍣➢ ปิด ❌"
                        if settings["autoJoin"] == True: ret_ += "\n╠⍣⌲ เข้าห้องอัตโนมัติ ⍣➢ เปิด ✔"
                        else: ret_ += "\n╠⍣⌲ เข้าห้องอัตโนมัติ ⍣➢ ปิด ❌"
                        if settings["autoCancel"]["on"] == True:ret_+="\n╠⍣⌲ ยกเลิกการเชิญกลุ่มจำนวนสมาชิค ⍣➢ " + str(settings["autoCancel"]["members"]) + "คน ✔"
                        else: ret_ += "\n╠⍣⌲ ยกเลิกการเชิญกลุ่ม ⍣➢ ปิด ❌"						
                        if settings["autoLeave"] == True: ret_ += "\n╠⍣⌲ ออกแชทรวมอัตโนมัติ ⍣➢ เปิด ✔"
                        else: ret_ += "\n╠⍣⌲ ออกแชทรวมอัตโนมัติ ⍣➢ ปิด ❌"
                        if settings["autoRead"] == True: ret_ += "\n╠⍣⌲ อ่านแชทอัตโนมัติ ⍣➢ เปิด ✔"
                        else: ret_ += "\n╠⍣⌲ อ่านแชทอัตโนมัติ ⍣➢ ปิด ❌"				
                        if settings["checkSticker"] == True: ret_ += "\n╠⍣⌲ อ่านโค้ดสติ๊กเกอร์อัตโนมัติ ⍣➢ เปิด ✔"
                        else: ret_ += "\n╠⍣⌲ อ่านโค๊ดสติ๊กเกอร์อัตโนมัติ ⍣➢ ปิด ❌"
                        if settings["kickMention"] == True: ret_ += "\n╠⍣⌲ ข้อความการห้ามแทค ⍣➢ เปิด ✔"
                        else: ret_ += "\n╠⍣⌲ ข้อความการห้ามแทค ⍣➢ ปิด ❌"
                        if settings["detectMention"] == True: ret_ += "\n╠⍣⌲ ข้อความการแทคที่1 ⍣➢ เปิด ✔"
                        else: ret_ += "\n╠⍣⌲ ข้อความการแทคที่1 ⍣➢ ปิด ❌"
                        if settings["detectMention2"] == True: ret_ += "\n╠⍣⌲ ข้อความการแทคที่2 ⍣➢ เปิด ✔"
                        else: ret_ += "\n╠⍣⌲ ข้อความการแทคที่2 ⍣➢ ปิด ❌"
                        if settings["detectMention3"] == True: ret_ += "\n╠⍣⌲ ข้อความการแทคที่3 ⍣➢ เปิด ✔"
                        else: ret_ += "\n╠⍣⌲ ข้อความการแทคที่3 ⍣➢ ปิด ❌"
                        if settings["potoMention"] == True: ret_ += "\n╠⍣⌲ ข้อความแทครูปภาพ ⍣➢ เปิด ✔"
                        else: ret_ += "\n╠⍣⌲ ข้อความแทครูปภาพ ⍣➢ ปิด ❌"						
                        if RfuProtect["inviteprotect"] == True: ret_ += "\n╠⍣⌲ ระบบป้องกันการเชิญ ⍣➢ เปิด ✔"
                        else: ret_ += "\n╠⍣⌲ ระบบป้องการกันเชิญ ⍣➢ ปิด ❌"
                        if RfuProtect["cancelprotect"] == True: ret_ += "\n╠⍣⌲ ระบบป้องกันการยกเลิกค้างเชิญ ⍣➢ เปิด ✔"
                        else: ret_ += "\n╠⍣⌲ ระบบป้องกันการยกเลิกค้างเชิญ ⍣➢ ปิด ❌"
                        if RfuProtect["protect"] == True: ret_ += "\n╠⍣⌲ ระบบป้องกันการโดนเตะ ⍣➢ เปิด ✔"
                        else: ret_ += "\n╠⍣⌲ ระบบป้องกันการโดนเตะ ⍣➢ ปิด ❌"
                        if RfuProtect["linkprotect"] == True: ret_ += "\n╠⍣⌲ ระบบป้องกันการเปิดลิ้ง ⍣➢ เปิด ✔"
                        else: ret_ += "\n╠⍣⌲ ระบบป้องกันการเปิดลิ้ง ⍣➢ ปิด ❌"
                        if RfuProtect["Protectguest"] == True: ret_ += "\n╠⍣⌲ ระบบป้องกันสมาชิค ⍣➢ เปิด ✔"
                        else: ret_ += "\n╠⍣⌲ ระบบป้องกันสมาชิค ⍣➢ ปิด ❌"
                        if RfuProtect["Protectjoin"] == True: ret_ += "\n╠⍣⌲ ระบบป้องกันการเข้าร่วมกลุ่ม ⍣➢ เปิด ✔"
                        else: ret_ += "\n╠⍣⌲ ระบบป้องกันการเข้าร่วมกลุ่ม ⍣➢ ปิด ❌"
                        ret_ += "\n╚┅┄┄┄┄┄┄⍣⊰✿۞✿⊱⍣┄┄┄┄┄┄┅╝"
                        line.sendMessage(to, str(ret_))
                    except Exception as e:
                        line.sendMessage(msg.to, str(e))
...
#==============================================================================#
                ...
                elif msg.text.lower().startswith("ดีส "):
...
#==============================================================================#   
                ...
                elif msg.text in ["Tagimage on","เปิดแทครูป"]:
                        settings['potoMention'] = True
                        line.sendMessage(msg.to,"【✥⍣เปิดแสดงโปรไฟล์คนที่แทคเรียบร้อย⍣✥】✔")
                
                elif msg.text in ["Tagimage off","ปิดแทครูป"]:
                        settings['potoMention'] = False
                        line.sendMessage(msg.to,"【✥⍣ปิดแสดงรูปโปรไฟล์คนที่แทคเรียบร้อย⍣✥】❌")

                elif msg.text in ["Respontag1 on","เปิดแทค1","Tag1 on","Respon1:on"]:
                    settings["detectMention"] = True
                    line.sendMessage(msg.to,"【✥⍣เปิดข้อความตอบการแทคที่1เรียบร้อย⍣✥】✔")
                
                elif msg.text in ["Respontag1 off","ปิดแทค1","Tag1 off","Respon1:off"]:
                    settings["detectMention"] = False
                    line.sendMessage(msg.to,"【✥⍣ปิดข้อความตอบรับการแทคที่1เรียบร้อย⍣✥】❌")

                elif msg.text in ["Respontag2 on","เปิดแทค2","Tag2 on","Respon2:on"]:
                    settings["detectMention2"] = True
                    line.sendMessage(msg.to,"【✥⍣เปิดข้อความตอบรับการแทคที่2เรียบร้อย⍣✥】✔")
                
                elif msg.text in ["Respontag2 off","ปิดแทค2","Tag2 off","Respon2:off"]:
                    settings["detectMention2"] = False
                    line.sendMessage(msg.to,"【✥⍣ปิดข้อความตอบรับการแทคที่2เรียบร้อย⍣✥】❌")

                elif msg.text in ["Respontag3 on","เปิดแทค3","Tag3 on","Respon3:on","เปิดแทคตัส"]:
                    settings["detectMention3"] = True
                    line.sendMessage(msg.to,"【✥⍣เปิดข้อความตอบรับการแทคที่3เรียบร้อย⍣✥】✔")
                
                elif msg.text in ["Respontag3 off","ปิดแทค3","Tag3 off","Respon3:off","ปิดแทคตัส"]:
                    settings["detectMention3"] = False
                    line.sendMessage(msg.to,"【✥⍣ปิดข้อความตอบรับการแทคที่3เรียบร้อย⍣✥】❌")

                elif msg.text in ["เปิดแทคคิก","Kicktag on","kicktag:on","เปิดแทคเตะ"]:
                    settings["kickMention"] = True
                    line.sendMessage(msg.to,"【✥⍣เปิดการเตะคนที่แทคเรียบร้อย⍣✥】✔")
                
                elif msg.text in ["ปิดแทคคิก","Kicktag off","kicktag:off","ปิดแทคเตะ"]:
                    settings["kickMention"] = False
                    line.sendMessage(msg.to,"【✥⍣ปิดการเตะคนที่แทคเรียบร้อย⍣✥】❌")
                  ...
                  if msg._from in admin:
                     ...
                     if spl in [""," ","\n",None]:
                         line.sendMessage(msg.to, "ตั้งข้อความคนแทคเรียบร้อย✏✏")
                     else:
                         settings["Respontag"] = spl
                         line.sendMessage(msg.to, "「Respon Msg」\nตั้งข้อความเรียบร้อย:\n\n「{}」".format(str(spl)))

                elif 'ตั้งข้อความคนเข้า: ' in msg.text:
                  if msg._from in admin:
                     spl = msg.text.replace('ตั้งข้อความคนเข้า: ','')
                     if spl in [""," ","\n",None]:
                         line.sendMessage(msg.to, "ตั้งข้อความเข้ากลุ่มเรียบร้อย✏✏")
                     else:
                          settings["welcome"] = spl
                          line.sendMessage(msg.to, "「Welcome Msg」\nตั้งข้อความคนเข้ากลุ่มเรืยบร้อย:\n\n「{}」".format(str(spl)))
                          
                elif 'ตั้งข้อความคนออก: ' in msg.text:
                  if msg._from in admin:
                     spl = msg.text.replace('ตั้งข้อความคนออก: ','')
                     if spl in [""," ","\n",None]:
                         line.sendMessage(msg.to, "ตั้งข้อความคนออกกลุ่ม📍📍")
                     else:
                          settings["bye"] = spl
                          line.sendMessage(msg.to, "「Bye Msg」\nตั้งข้อความคนออกเรืยบร้อย:\n\n「{}」".format(str(spl)))
...
#                    print  ("ok")
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            ...
                            if msg.toType == 2:
                                ...
                                num = int(strnum)
                                line.sendMessage(to, "เชิญเข้าร่วมการโทรสำเร็จ(｀・ω・´)")
                ...
                elif msg.text in ["รีบูท"]:
                	line.sendMessage(msg.to, "【✥⍣กำลังรีบูท..กรุณารอสักครู่⍣✥】 ⌛⌛")
                    line.sendMessage(msg.to, "LOADING:▒...0%")
                    line.sendMessage(msg.to, "█▒... 10.0%")
                    line.sendMessage(msg.to, "██▒... 20.0%")
                    line.sendMessage(msg.to, "███▒... 30.0%")
                    line.sendMessage(msg.to, "████▒... 40.0%")
                    line.sendMessage(msg.to, "█████▒... 50.0%")
                    line.sendMessage(msg.to, "██████▒... 60.0%")
                    line.sendMessage(msg.to, "███████▒... 70.0%")
                    line.sendMessage(msg.to, "████████▒... 80.0%")
                    line.sendMessage(msg.to, "█████████▒... 90.0%")
                    line.sendMessage(msg.to, "██████████▒... 99.9%")
                    line.sendMessage(msg.to, "███████████▒... 100.0%")
                    line.sendMessage(msg.to, "【✥⍣REBOOTS.. COMPLETE⍣✥】✔")
                    line.sendMessage(msg.to, "〘•ทำการรีบูทสำเร็จ..เรียบร้อย•〙 (*¯︶¯*)✔")
                    line.sendMessage(msg.to, "✍BY➢【✥Ŧ€₳ℳধ௫฿❂Ŧ🔝ҨัՁਙุЮℓℓ丂ს✥】..✔")
                    line.sendMessage(msg.to,"【✥REBOOT BY⍣⌲ ͲᎪᎬᎷßΘͲ ĦᏌᎪ~ᎡᎾᎾΝ~ᎡᎪΝᏀ✥】")
...
#=============COMMAND PROTECT=========================#
                    ...
                    if RfuProtect["inviteprotect"] == True:
                        ...
                        RfuProtect["inviteprotect"] = True
                        if settings["lang"] == "JP":
                            line.sendMessage(msg.to,"【✥⍣เปิดระบบป้องกันการเชิญ⍣✥】✔")
                    if RfuProtect["cancelprotect"] == True:
                        if settings["lang"] == "JP":
                            line.sendMessage(msg.to,"【✥⍣เปิดระบบป้องกันการยกเลิกค้างเชิญ⍣✥】✔")
                        else:
                            line.sendMessage(msg.to,"【✥⍣เปิดระบบป้องกันการยกเลิกค้างเชิญ⍣✥】✔")
                    else:
                        RfuProtect["cancelprotect"] = True
                    ...
                    if RfuProtect["protect"] == True:
                        ...
                        RfuProtect["protect"] = True
                        if settings["lang"] == "JP":
                            line.sendMessage(msg.to,"【✥⍣เปิดระบบป้องกันการโดนเตะ⍣✥】✔")
                        else:
                            line.sendMessage(msg.to,"【✥⍣เปิดระบบป้องกันการโดนเตะ⍣✥】✔")
                    if RfuProtect["linkprotect"] == True:
                        if settings["lang"] == "JP":
                            line.sendMessage(msg.to,"【✥⍣เปิดระบบป้องกันสมาชิคเปิดลิ้ง⍣✥】✔")
                        else:
                            line.sendMessage(msg.to,"【✥⍣เปิดระบบป้องกันสมาชิคเปิดลิ้ง⍣✥】✔")
                    else:
                        RfuProtect["linkprotect"] = True
                    ...
                    if RfuProtect["Protectguest"] == True:
                        if settings["lang"] == "JP":
                            line.sendMessage(msg.to,"【✥⍣เปิดระบบป้องกันสมาชิคภายในกลุ่ม⍣✥】✔")
                        else:
                            line.sendMessage(msg.to,"【✥⍣เปิดระบบป้องกันสมาชิคภายในกลุ่ม⍣✥】✔")
                    else:
                        RfuProtect["Protectguest"] = True
                    ...
                    if RfuProtect["Protectjoin"] == True:
                        if settings["lang"] == "JP":
                            line.sendMessage(msg.to,"【✥⍣เปิดระบบป้องกันบุคคลภายนอกเข้าร่วมกลุ่ม⍣✥】✔")
                        else:
                            line.sendMessage(msg.to,"【✥⍣เปิดระบบป้องกันบุคคลภายนอกเข้าร่วมกลุ่ม⍣✥】✔")
                    else:
                        RfuProtect["Protectjoin"] = True
                        if settings["lang"] == "JP":
                            line.sendMessage(msg.to,"【✥⍣เปิดระบบป้องกันบุคคลภายน้อกเข้าร่วมกลุ่ม⍣✥】✔")
                        else:
                            line.sendMessage(msg.to,"【✥⍣เปิดระบบป้องกันบุคคลภายนอกเข้าร่วมกลุ่ม⍣✥】✔")
                    ...
                    if RfuProtect["inviteprotect"] == False:
                        ...
                        RfuProtect["inviteprotect"] = False
                        if settings["lang"] == "JP":
                            line.sendMessage(msg.to,"【✥⍣ปิดระบบป้องกันการเชิญ⍣✥】❌")
                    if RfuProtect["cancelprotect"] == False:
                        if settings["lang"] == "JP":
                            line.sendMessage(msg.to,"【✥⍣ปิดระบบป้องกันการยกเลิกค้างเชิญ⍣✥】❌")
                        else:
                            line.sendMessage(msg.to,"【✥⍣ปิดระบบป้องกันการยกเลิกค้างเชิญ⍣✥】❌")
                    else:
                        RfuProtect["cancelprotect"] = False
                    ...
                    if RfuProtect["protect"] == False:
                        if settings["lang"] == "JP":
                            line.sendMessage(msg.to,"【✥⍣ปิดระบบป้องกันการโดนเตะ⍣✥】❌")
                        else:
                            line.sendMessage(msg.to,"【✥⍣ปิดระบบป้องกันการโดนเตะ⍣✥】❌")
                    else:
                        RfuProtect["protect"] = False
                    ...
                    if RfuProtect["linkprotect"] == False:
                        if settings["lang"] == "JP":
                            line.sendMessage(msg.to,"【✥⍣ปิดระบบป้องกันสมาชิคเปิดลิ้ง⍣✥】❌")
                        else:
                            line.sendMessage(msg.to,"【✥⍣ปิดระบบป้องกันสมาชิคเปิดลิ้ง⍣✥】❌")
                    else:
                        RfuProtect["linkprotect"] = False
                    ...
                    if RfuProtect["Protectguest"] == False:
                        if settings["lang"] == "JP":
                            line.sendMessage(msg.to,"【✥⍣ปิดระบบป้องกันสมาชิคภายในกลุ่ม⍣✥】❌")
                        else:
                            line.sendMessage(msg.to,"【✥⍣ปิดระบบป้องกันสมาชิคภายในกลุ่ม⍣✥】❌")
                    else:
                        RfuProtect["Protectguest"] = False
                    ...
                    if RfuProtect["Protectjoin"] == False:
                        if settings["lang"] == "JP":
                            line.sendMessage(msg.to,"【✥⍣ปิดป้องกันบุคคลภายนอกเข้าร่วมกลุ่ม⍣✥】❌")
                        else:
                            line.sendMessage(msg.to,"【✥⍣ปิดป้องกันบุคคลภายนอกเข้าร่วมกลุ่ม⍣✥】❌")
                    else:
                        RfuProtect["Protectjoin"] = False
                        if settings["lang"] == "JP":
                            line.sendMessage(msg.to,"【✥⍣ปิดระบบป้องกันบุคคลภายนอกเข้าร่วมกลุ่ม⍣✥】❌")
                        else:
                            line.sendMessage(msg.to,"【✥⍣ปิดระบบป้องกันบุคคลภายนอกเข้าร่วมกลุ่ม⍣✥】❌")
                ...
                if msg.contentType == 0 and sender not in lineMID and msg.toType == 2:
                    if "MENTION" in list(msg.contentMetadata.keys()) != None:
                         if settings['detectMention3'] == True:
                             ...
                             balas1 = "แทกไม่พูด..กือดึงตัสแม่งสาสส 555+😅😅😅\n" + contact.statusMessage
                             ret_ = random.choice(balas)
                             image = "http://dl.profile.line-cdn.net/" + contact.pictureStatus                          
                             name = re.findall(r'@(\w+)', msg.text)
                             mention = ast.literal_eval(msg.contentMetadata["MENTION"])
...
# ----------------- NOTIFED MEMBER JOIN GROUP
       ...
       #         line.sendMessage(op.param1,"กราบสวัสดี..🤣🤣🤣 " + line.getContact(op.param2).displayName + "\n🤣🤣..ยินดีต้อนรับ ☞ " + str(ginfo.name) + " ☜" + "\n!!!..เข้ามาล้ะปิดแจ้งเตือนด้วยนะคัฟ ห้ามดื้อห้ามซนนะ ^^✌✌\n##...ด้วยความปราถนาดีจาก...## \n ⍣⌲•【✥Ŧ€₳ℳধ௫฿❂Ŧ🔝ҨัՁਙุЮℓℓ丂ს✥】")
        ...
        if op.type == 15:
          if settings['Lv'] == True:
            if op.param2 in lineMID:
             ...
             contact = line.getContact(op.param2)
             image = "http://dl.profile.line.naver.jp/" + contact.pictureStatus
             line.sendMessage(op.param1,"อ้าวววว....😭😭😭 " + line.getContact(op.param2).displayName + "\nขอให้เทอไปดี..ขอให้มีความสุข.. \n ขอให้เทอหมดทุข..เสียที..(p′︵‵。)")
