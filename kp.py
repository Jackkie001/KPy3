...
#==============================================================================#
                    ...
                    try:
                        ...
                        if settings["detectMention"] == True: ret_ += "\n╠⍣⌲ ข้อความตอบรับการแทคที่1 ⍣➢ เปิด ✔"
                        else: ret_ += "\n╠⍣⌲ ข้อความตอบรับการแทคที่1 ⍣➢ ปิด ❌"
                        if settings["detectMention2"] == True: ret_ += "\n╠⍣⌲ ข้อความตอบรับการแทคที่2 ⍣➢ เปิด ✔"
                        else: ret_ += "\n╠⍣⌲ ข้อความตอบรับการแทคที่2 ⍣➢ ปิด ❌"
                        if settings["detectMention3"] == True: ret_ += "\n╠⍣⌲ ข้อความตอบรับการแทคที่3 ⍣➢ เปิด ✔"
                        else: ret_ += "\n╠⍣⌲ ข้อความตอบรับการแทคที่3 ⍣➢ ปิด ❌"
                        if settings["potoMention"] == True: ret_ += "\n╠⍣⌲ ข้อความตอบรับการแสดงโปรไฟล์คนที่แทค ⍣➢ เปิด ✔"
                        else: ret_ += "\n╠⍣⌲ ข้อความตอบรับการแสดงโปรไฟล์คนที่แทค ⍣➢ ปิด ❌"						
...
#==============================================================================#   
                ...
                elif msg.text in ["Respontag3 on","เปิดแทค3","Tag3 on","Respon3:on"]:
                    settings["detectMention3"] = True
                    line.sendMessage(msg.to,"【✥⍣เปิดข้อความตอบรับการแทคที่3เรียบร้อย⍣✥】✔")
                
                elif msg.text in ["Respontag3 off","ปิดแทค3","Tag3 off","Respon3:off"]:
                  ...
                  if msg._from in admin:
                     ...
                     if spl in [""," ","\n",None]:
                         line.sendMessage(msg.to, "ตั้งข้อความเรียบร้อย")
                     else:
                         ...
                         if settings['detectMention2'] == True:
                             ...
                             for mention in mentionees:
                                   if mention['M'] in lineMID:
                                          ...
                                          line.sendMessage(to,str(settings["Respontag","tag1","tag2","tag3"]))
                                          line.sendImageWithURL(to,image)
                                          line.sendMessageWithMention(to, contact.mid)
                                          line.sendMessage(msg.to, None, contentMetadata={"STKID":"20575180","STKPKGID":"9529","STKVER":"1"}, contentType=7)
                                          break
                if msg.contentType == 0 and sender not in lineMID and msg.toType == 2:
                    if "MENTION" in list(msg.contentMetadata.keys()) != None:
                         if settings['detectMention3'] == True:
                             contact = line.getContact(msg._from)
                             cName = contact.displayName
                             path = line.getProfileCoverURL(msg._from)
                             balas = [cName + "\n" + str(settings["tag1"]) , cName + "\n" + str(settings["tag2"]), cName + "\n" + str(settings["tag3"])]
